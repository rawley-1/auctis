...
from debug import print_query_plan
...
def infer_caremark_facts_from_question(question: str) -> Dict[str, bool]:
    ...
    return {
        ...
        "monitors_reporting_system": not any(phrase in q for phrase in [
            "failed to monitor", "ignored monitoring", "consciously failed to monitor",
            "did not monitor", "never reviewed reports",
        ]),
        "mission_critical_risk": any(phrase in q for phrase in [
            "mission critical", "food safety", "core compliance", "regulatory risk", "safety issue",
        ]),
